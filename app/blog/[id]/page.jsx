      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: "Home",
          item: "https://kodesword.vercel.app",
        },
        {
          "@type": "ListItem",
          position: 2,
          name: "Blog",
          item: "https://kodesword.vercel.app/blog",
        },
        {
          "@type": "ListItem",
          position: 3,
          name: post.title,
          item: `https://kodesword.vercel.app/blog/${post.slug}`,
        },
      ],
    },
  ];
    ...
    <>
      ...
      <article className="min-h-screen mt-13 bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-2 py-8 sm:py-12">
          <div
            className="bg-white rounded-2xl overflow-x-auto text-wrap shadow-sm p-6 sm:p-8 lg:p-12"
