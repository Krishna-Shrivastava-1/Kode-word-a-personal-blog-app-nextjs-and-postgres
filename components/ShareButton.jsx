...
export default function ShareButton({ postId, title, description }) {
    ...
    <div className="relative">
      ...
      {showMenu && (
        <>
          ...
          {/* Menu */}
          <div className="absolute top-full right-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 w-[220px]">
            <div className="p-2">
              {/* Copy Link */}
              <button
